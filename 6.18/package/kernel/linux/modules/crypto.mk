...
define KernelPackage/crypto-hw-hifn-795x
  ...
  FILES:=$(LINUX_DIR)/drivers/crypto/hifn_795x.ko@lt6.18
  AUTOLOAD:=$(call AutoLoad,09,!LINUX_6_18:hifn_795x)
...
define KernelPackage/crypto-sha1/aarch64-ce
  ...
  AUTOLOAD+=$(call AutoLoad,09,!LINUX_6_18:sha1-ce)
endef
...
define KernelPackage/crypto-sha256/aarch64
  FILES+=$(LINUX_DIR)/arch/arm64/crypto/sha256-arm64.ko@lt6.18
  AUTOLOAD+=$(call AutoLoad,09,!LINUX_6_18:sha256-arm64)
endef

define KernelPackage/crypto-sha256/aarch64-ce
  $(call KernelPackage/crypto-sha256/aarch64)
  FILES+=$(LINUX_DIR)/arch/arm64/crypto/sha2-ce.ko@lt6.18
  AUTOLOAD+=$(call AutoLoad,09,!LINUX_6_18:sha2-ce)
endef
...
define KernelPackage/crypto-sha512/arm
  FILES+=$(LINUX_DIR)/arch/arm/crypto/sha512-arm.koo@lt6.18
  AUTOLOAD+=$(call AutoLoad,09,!LINUX_6_18:sha512-arm)
endef

define KernelPackage/crypto-sha512/aarch64
  FILES+=$(LINUX_DIR)/arch/arm64/crypto/sha512-arm64.koo@lt6.18
...
define KernelPackage/crypto-test
  ...
  FILES:=$(LINUX_DIR)/crypto/tcrypt.ko@lt6.18
