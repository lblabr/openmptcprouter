...
define KernelPackage/hwmon-gsc
  ...
  KCONFIG:=CONFIG_MFD_GATEWORKS_GSC \
        CONFIG_SENSORS_GSC
  FILES:= \
	$(LINUX_DIR)/drivers/mfd/gateworks-gsc.ko@lt6.18 \
	$(LINUX_DIR)/drivers/hwmon/gsc-hwmon.ko@lt6.18
  AUTOLOAD:=$(call AutoLoad,20,!LINUX_6_18:gsc-hwmon,1)
...
define KernelPackage/hwmon-gpiofan
  ...
  FILES:=$(LINUX_DIR)/drivers/hwmon/gpio-fan.ko@lt6.18
  AUTOLOAD:=$(call AutoLoad,60,!LINUX_6_18:gpio-fan)
