...
define KernelPackage/iio-lsm6dsx
  ...
  FILES:=$(LINUX_DIR)/drivers/iio/imu/st_lsm6dsx/st_lsm6dsx.ko@lt6.18
  AUTOLOAD:=$(call AutoProbe,!LINUX_6_18:st_lsm6dsx)
  $(call AddDepends/iio)
endef
...
define KernelPackage/iio-lsm6dsx-i2c
  ...
  KCONFIG:=CONFIG_IIO_ST_LSM6DSX
  FILES:=$(LINUX_DIR)/drivers/iio/imu/st_lsm6dsx/st_lsm6dsx_i2c.ko@lt6.18
  AUTOLOAD:=$(call AutoProbe,!LINUX_6_18:st_lsm6dsx-i2c)
  $(call AddDepends/iio)
endef
...
define KernelPackage/iio-lsm6dsx-spi
  ...
  KCONFIG:=CONFIG_IIO_ST_LSM6DSX
  FILES:=$(LINUX_DIR)/drivers/iio/imu/st_lsm6dsx/st_lsm6dsx_spi.ko@lt6.18
  AUTOLOAD:=$(call AutoProbe,!LINUX_6_18:st_lsm6dsx-spi)
  $(call AddDepends/iio)
endef
