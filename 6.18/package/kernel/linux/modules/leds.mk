...
define KernelPackage/leds-group-multicolor
  ...
  FILES:=$(LINUX_DIR)/drivers/leds/rgb/leds-group-multicolor.ko@lt6.18
  AUTOLOAD:=$(call AutoProbe,!LINUX_6_18:leds-group-multicolor)
endef
...
define KernelPackage/leds-st1202
  ...
  FILES:= $(LINUX_DIR)/drivers/leds/leds-st1202.ko@lt6.18
  AUTOLOAD:=$(call AutoProbe,!LINUX_6_18:leds-st1202)
endef
...
define KernelPackage/leds-lp55xx-common
  ...
  FILES:=$(LINUX_DIR)/drivers/leds/leds-lp55xx-common.ko@lt5.18
  AUTOLOAD:=$(call AutoLoad,60,!LINUX_6_18:leds-lp55xx-common,1)
endef
...
define KernelPackage/leds-lp5523
  ...
  FILES:=$(LINUX_DIR)/drivers/leds/leds-lp5523.ko@lt6.18
  AUTOLOAD:=$(call AutoLoad,60,!LINUX_6_18:leds-lp5523,1)
endef
...
define KernelPackage/leds-lp5562
  ...
  FILES:=$(LINUX_DIR)/drivers/leds/leds-lp5562.ko@lt6.18
  AUTOLOAD:=$(call AutoLoad,60,!LINUX_6_18:leds-lp5562,1)
endef
