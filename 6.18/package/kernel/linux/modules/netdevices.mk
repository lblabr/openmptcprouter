...
define KernelPackage/libie-adminq
  ...
  DEPENDS:=+kmod-libie
  KCONFIG:=$(if $(CONFIG_LINUX_6_18),,CONFIG_LIBIE_ADMINQ)
  HIDDEN:=1
...
define KernelPackage/phy-at803x
   ...
   FILES:=$(LINUX_DIR)/drivers/net/phy/qcom/at803x.ko@lt6.18
   AUTOLOAD:=$(call AutoLoad,18,!LINUX_6_18:at803x,1)
endef
...
define KernelPackage/swconfig
  ...
  FILES:=$(wildcard $(LINUX_DIR)/drivers/net/phy/swconfig.ko)
...
define KernelPackage/switch-ip17xx
  ...
  FILES:=$(wildcard $(LINUX_DIR)/drivers/net/phy/ip17xx.ko)
...
define KernelPackage/switch-rtl8306
  ...
  FILES:=$(wildcard $(LINUX_DIR)/drivers/net/phy/rtl8306.ko)
...
define KernelPackage/switch-rtl8366-smi
  ...
  FILES:=$(wildcard $(LINUX_DIR)/drivers/net/phy/rtl8366_smi.ko)
...
define KernelPackage/switch-rtl8366rb
  ...
  FILES:=$(wildcard $(LINUX_DIR)/drivers/net/phy/rtl8366rb.ko)
...
define KernelPackage/switch-rtl8366s
  ...
  FILES:=$(wildcard $(LINUX_DIR)/drivers/net/phy/rtl8366s.ko)
...
define KernelPackage/switch-rtl8367
  ...
  FILES:=$(wildcard $(LINUX_DIR)/drivers/net/phy/rtl8367.ko)
...
define KernelPackage/switch-rtl8367b
  ...
  FILES:=$(wildcard $(LINUX_DIR)/drivers/net/phy/rtl8367b.ko)
...
define KernelPackage/switch-ar8xxx
  ...
  FILES:=$(wildcard $(LINUX_DIR)/drivers/net/phy/ar8xxx.ko)
...
define KernelPackage/natsemi
  ...
  FILES:=$(wildcard $(LINUX_DIR)/drivers/net/ethernet/natsemi/natsemi.ko)
...
define KernelPackage/dm9000
  ...
  FILES:=$(wildcard $(LINUX_DIR)/drivers/net/ethernet/davicom/dm9000.ko)
