...
define KernelPackage/nf-ipt6
  ...
  FILES:=$(wildcard $(foreach mod,$(NF_IPT6-m),$(LINUX_DIR)/net/$(mod).ko))
...
define KernelPackage/ipt-core
  ...
  FILES:=$(wildcard $(foreach mod,$(IPT_CORE-m),$(LINUX_DIR)/net/$(mod).ko))
...
define KernelPackage/ipt-filter
  ...
  AUTOLOAD:=$(wildcard $(call AutoProbe,$(notdir $(IPT_FILTER-m))))
...
define KernelPackage/ipt-nat
  ...
  FILES:=$(widcard $(foreach mod,$(IPT_NAT-m),$(LINUX_DIR)/net/$(mod).ko))
...
define KernelPackage/ipt-raw
  ...
  FILES:=$(wildcard $(LINUX_DIR)/net/ipv4/netfilter/iptable_raw.ko)
...
define KernelPackage/ipt-raw6
  ...
  FILES:=$(wildcard $(LINUX_DIR)/net/ipv6/netfilter/ip6table_raw.ko)
...
define KernelPackage/ipt-nat6
  ...
  FILES:=$(wildcard $(foreach mod,$(IPT_NAT6-m),$(LINUX_DIR)/net/$(mod).ko))
...
define KernelPackage/ipt-nat-extra
  ...
  FILES:=$(wildcard $(foreach mod,$(IPT_NAT_EXTRA-m),$(LINUX_DIR)/net/$(mod).ko))
...
define KernelPackage/nf-nathelper
  ...
  FILES:=$(wildcard $(foreach mod,$(NF_NATHELPER-m),$(LINUX_DIR)/net/$(mod).ko))
...
define KernelPackage/nf-nathelper-extra
  ...
  FILES:=$(wildcard $(foreach mod,$(NF_NATHELPER_EXTRA-m),$(LINUX_DIR)/net/$(mod).ko))
...
define KernelPackage/ipt-debug
  ...
  FILES:=$(wildcard $(foreach mod,$(IPT_DEBUG-m),$(LINUX_DIR)/net/$(mod).ko))
...
define KernelPackage/ip6tables
  ...
  FILES:=$(wildcard $(foreach mod,$(IPT_IPV6-m),$(LINUX_DIR)/net/$(mod).ko))
...
define KernelPackage/ebtables
  ...
  DEPENDS:=+kmod-ipt-core
  FILES:=$(wildcard $(foreach mod,$(EBTABLES-m),$(LINUX_DIR)/net/$(mod).ko))
...
define KernelPackage/ebtables-ipv4
  ...
  FILES:=$(wildcard $(foreach mod,$(EBTABLES_IP4-m),$(LINUX_DIR)/net/$(mod).ko))
...
define KernelPackage/ebtables-ipv6
  ...
  DEPENDS:=@IPV6
  FILES:=$(wildcard $(foreach mod,$(EBTABLES_IP6-m),$(LINUX_DIR)/net/$(mod).ko))
...
define KernelPackage/ebtables-watchers
  ...
  FILES:=$(wildcard $(foreach mod,$(EBTABLES_WATCHERS-m),$(LINUX_DIR)/net/$(mod).ko))
...
define KernelPackage/nfnetlink
  ...
  FILES:=$(wildcard $(foreach mod,$(NFNETLINK-m),$(LINUX_DIR)/net/$(mod).ko))
...
define KernelPackage/nft-core
  ...
  FILES:=$(wildcard $(foreach mod,$(NFT_CORE-m),$(LINUX_DIR)/net/$(mod).ko))
