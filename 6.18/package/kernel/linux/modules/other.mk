...
define KernelPackage/dma-buf
  ...
  AUTOLOAD:=$(call AutoLoad,20,!LINUX_6_18:dma-shared-buffer)
endef
...
define KernelPackage/mtdoops
  ...
  FILES:=$(wildcard $(LINUX_DIR)/drivers/mtd/mtdoops.ko)
endef
...
define KernelPackage/mtdram
  ...
  FILES:=$(wildcard $(LINUX_DIR)/drivers/mtd/devices/mtdram.ko)
endef
...
define KernelPackage/ramoops
  ...
  FILES:= $(wildcard $(LINUX_DIR)/fs/pstore/ramoops.ko)
...
define KernelPackage/echo
  ...
  KCONFIG:=CONFIG_ECHO
  FILES:=$(wildcard $(LINUX_DIR)/drivers/misc/echo/echo.ko)
...
define KernelPackage/regulator-userspace-consumer
  ...
  FILES:=$(wildcard $(LINUX_DIR)/drivers/regulator/userspace-consumer.ko)
