...
define KernelPackage/rtc-bq32k
  ...
  KCONFIG:=CONFIG_RTC_DRV_BQ32K \
	CONFIG_RTC_CLASS=y
  FILES:=$(wildcard $(LINUX_DIR)/drivers/rtc/rtc-bq32k.ko)
...
define KernelPackage/rtc-ds1307
  ...
  KCONFIG:=CONFIG_RTC_DRV_DS1307 \
	CONFIG_RTC_CLASS=y
  FILES:=$(wildcard $(LINUX_DIR)/drivers/rtc/rtc-ds1307.ko)
...
define KernelPackage/rtc-ds1374
  ...
  KCONFIG:=CONFIG_RTC_DRV_DS1374 \
	...
	CONFIG_RTC_CLASS=y
  FILES:=$(wildcard $(LINUX_DIR)/drivers/rtc/rtc-ds1374.ko)
...
define KernelPackage/rtc-ds1672
  ...
  KCONFIG:=CONFIG_RTC_DRV_DS1672 \
	CONFIG_RTC_CLASS=y
  FILES:=$(wildcard $(LINUX_DIR)/drivers/rtc/rtc-ds1672.ko)
...
define KernelPackage/rtc-em3027
  ...
  KCONFIG:=CONFIG_RTC_DRV_EM3027 \
	CONFIG_RTC_CLASS=y
  FILES:=$(wildcard $(LINUX_DIR)/drivers/rtc/rtc-em3027.ko)
...
define KernelPackage/rtc-isl1208
  ...
  KCONFIG:=CONFIG_RTC_DRV_ISL1208 \
	CONFIG_RTC_CLASS=y
  FILES:=$(wildcard $(LINUX_DIR)/drivers/rtc/rtc-isl1208.ko)
...
define KernelPackage/rtc-mv
  ...
  KCONFIG:=CONFIG_RTC_DRV_MV \
	CONFIG_RTC_CLASS=y
  FILES:=$(wildcard $(LINUX_DIR)/drivers/rtc/rtc-mv.ko)
...
define KernelPackage/rtc-pcf8563
  ...
  KCONFIG:=CONFIG_RTC_DRV_PCF8563 \
	CONFIG_RTC_CLASS=y
  FILES:=$(wildcard $(LINUX_DIR)/drivers/rtc/rtc-pcf8563.ko)
...
define KernelPackage/rtc-pcf2123
  ...
  KCONFIG:=CONFIG_RTC_DRV_PCF2123 \
	CONFIG_RTC_CLASS=y
  FILES:=$(wildcard $(LINUX_DIR)/drivers/rtc/rtc-pcf2123.ko)
...
define KernelPackage/rtc-pcf2127
  ...
  KCONFIG:=CONFIG_RTC_DRV_PCF2127 \
	CONFIG_RTC_CLASS=y
  FILES:=$(wildcard $(LINUX_DIR)/drivers/rtc/rtc-pcf2127.ko)
...
define KernelPackage/rtc-r7301
  ...
  KCONFIG:=CONFIG_RTC_DRV_R7301 \
	CONFIG_RTC_CLASS=y
  FILES:=$(wildcard $(LINUX_DIR)/drivers/rtc/rtc-r7301.ko)
...
define KernelPackage/rtc-rs5c372a
  ...
  KCONFIG:=CONFIG_RTC_DRV_RS5C372 \
	CONFIG_RTC_CLASS=y
  FILES:=$(wildcard $(LINUX_DIR)/drivers/rtc/rtc-rs5c372.ko)
...
define KernelPackage/rtc-rx8025
  ...
  KCONFIG:=CONFIG_RTC_DRV_RX8025 \
	CONFIG_RTC_CLASS=y
  FILES:=$(wildcard $(LINUX_DIR)/drivers/rtc/rtc-rx8025.ko)
...
define KernelPackage/rtc-s35390a
  ...
  KCONFIG:=CONFIG_RTC_DRV_S35390A \
	CONFIG_RTC_CLASS=y
  FILES:=$(wildcard $(LINUX_DIR)/drivers/rtc/rtc-s35390a.ko)
...
define KernelPackage/rtc-x1205
  ...
  KCONFIG:=CONFIG_RTC_DRV_X1205 \
	CONFIG_RTC_CLASS=y
  FILES:=$(wildcard $(LINUX_DIR)/drivers/rtc/rtc-x1205.ko)
